defmodule Y4mTest do
  ...
  test "read y4m header" do
    ...
    {:ok, file} = StringIO.open("YUV4MPEG2 W512 H288 F2:1 Ip A1:1 C444 XYSCSS=444 XCOLORRANGE=LIMITED")
  ...
  test "read y4m header frame rate" do
    1..16 |> Enum.map(fn nom ->
      1..16 |> Enum.map(fn den ->
  ...
  test "read y4m header color space" do
    color_spaces = [
      :C420jpeg, :C420paldv, :C420, :C422, :C444, :Cmono
    ]
  ...
  test "iter y4m frames" do
    ...
    read_frames = Y4mReader.read(file)
